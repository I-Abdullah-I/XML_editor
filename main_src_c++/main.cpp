...
// GUI functions
std::vector<Tag> check_for_errors(std::string file_path, std::vector<Tag> &errors);           
...
int main()
{
    ...
    check_for_errors("example.xml", errors);
    // fix_and_save("example.xml");
    // cout << fix_and_save("example.xml") << endl;
    cout << endl;
}
...
std::vector<Tag> check_for_errors(std::string file_path, std::vector<Tag> &error_array) {
